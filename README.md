...
Заранее создал дерево возможных путей (класс [MoveNode]).
...
При оценке риска маршрута моего бота я учитывал каждого сопреника независимо. 
...
Учет будущей гибели соперника. Иногда случалось так, что бот захватывает территорию соперника, 
